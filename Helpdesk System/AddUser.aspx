<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="Helpdesk_System.AddUser" %>
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-description"> 
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="UserPassword" runat="server" name="password" placeholder="Enter User Password" required>
                       <span class="messages"></span> 
                        </div>
                      </div>
                       <div class="form-group row">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Type of User</label>
                        <div class="col-sm-9">
                          <div class="form-group row">
                            <div class="col-sm-4">
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" runat="server" name="membershipRadios" id="Checkbox1" value="User" checked>User</label>
                              </div>
                            </div>
                            <div class="col-sm-5">
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" runat="server" name="membershipRadios" id="Checkbox2" value="Admin"> Admin </label>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="form-group row">
                        <div class="col-sm-9">
                          <asp:Button type="submit" cssclass="btn btn-primary m-b-0" runat="server" Text="Add User" onclick="Add_User"/>
                        </div>
                      </div>
                   </div>
                </div>
