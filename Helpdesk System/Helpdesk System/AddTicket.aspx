<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTicket.aspx.cs" Inherits="Helpdesk_System.AddTicket" %>
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-description"> 
                      <asp:Label ForeColor="Red" Font-Size="Medium" ID="StatusLabel" runat="server" data-type="success" data-from="top" data-align="right"></asp:Label>
                       ...
                       <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Staff ID</label>
                        <div class="col-sm-9">
                             <input type="text" id="UserID" name="UserID" placeholder="Staff ID" runat="server"  class="form-control required" required>
                          <span class="messages"></span>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Staff Email</label>
                        <div class="col-sm-9">
                             <input type="Email" id="UserEmail" name="UserEmail" placeholder="Staff Email (optional)" runat="server"  class="form-control required">
                          <span class="messages"></span>
                        </div>
                      </div>
                      <div class="form-group row">
