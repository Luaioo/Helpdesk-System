<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminTicketList.aspx.cs"  Inherits="Helpdesk_System.AdminTicketList" %>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                                    ...
                                    <asp:SqlDataSource ID="Database" runat="server" ConnectionString="<%$ ConnectionStrings:Database %>" SelectCommand="SELECT * FROM [Tickets] ORDER BY Reportdate DESC "> 
                                    </asp:SqlDataSource>
                                      ...
                                      <asp:GridView class="table" ID="GridView" runat="server" DataKeyNames="TID" DataSourceID="Database" AllowPaging="True" AutoGenerateColumns="False" style="margin-left: 25px; margin-top: 10px; margin-bottom: 50px" BackColor="#ffffff" BorderColor="transparent" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Width="97%">
                                           <Columns>  
                                             ...
                                             <asp:BoundField DataField="AssignedUser" HeaderText="Assigned To" SortExpression="Assigned To" />  
