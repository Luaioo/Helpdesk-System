<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminUserList.aspx.cs" Inherits="Helpdesk_System.UserList" %>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                         ...
                         <asp:SqlDataSource ID="Database" runat="server" ConnectionString="<%$ ConnectionStrings:Database %>" SelectCommand="SELECT * FROM [Users] ORDER BY Name ASC " DeleteCommand="DELETE FROM [Users] WHERE [UID] = @UID"  UpdateCommand="UPDATE [Users] SET  Name=@Name  , Email=@Email , Typeofuser=@Typeofuser WHERE [UID] = @UID"> 
                                                 <DeleteParameters>
                                      ...
                                      <asp:GridView class="table" ID="GridView1" runat="server" DataKeyNames="UID" DataSourceID="Database" AllowPaging="True" AutoGenerateColumns="False" style="margin-left: 25px; margin-top: 10px; margin-bottom: 50px" BackColor="#ffffff" BorderColor="transparent" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Width="97%">
                                           <Columns>  
                                             <asp:BoundField DataField="UID" HeaderText="User ID" SortExpression="Name" />
                                             <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
                                             <asp:BoundField DataField="Email" HeaderText="Email" SortExpression="Email" />  
                                             <asp:BoundField DataField="Typeofuser" HeaderText="Type of User" SortExpression="Typeofuser" />  
                                               <asp:TemplateField HeaderText="View Details">
                                                  <ItemTemplate>                                                     
                                                   <asp:LinkButton runat="server" ID="View" OnClick="View_Click" class="btn btn-block btn-lg btn-gradient-primary mt-4">View</asp:LinkButton>
                                                  </ItemTemplate>
                                                 </asp:TemplateField>
                                         </Columns>
