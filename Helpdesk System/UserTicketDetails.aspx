<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserTicketDetails.aspx.cs"   Inherits="Helpdesk_System.UserTicketDetails" %>
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-description"> 
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <textarea placeholder="Staff Comment" id="Comment" name="message" runat="server" class="form-control" readonly></textarea>
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> 
                      ...
                      <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">User Email</label>
                        <div class="col-sm-9">
                            <input type="text" id="Email" runat="server" class="form-control" readonly> 
                        </div>
                      </div>
                       <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Alternative Email</label>
                        <div class="col-sm-9">
