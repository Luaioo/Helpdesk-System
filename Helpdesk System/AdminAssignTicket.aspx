<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAssignTicket.aspx.cs" Inherits="Helpdesk_System.AdminAssignTicket" %>
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-description"> 
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">User ID</label>
                        <div class="col-sm-9">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-description"> 
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <textarea placeholder="Staff Comment" id="Comment" name="message" runat="server" class="form-control"></textarea>
                        </div>
                      </div>
                        <asp:Button ID="Completed" type="submit" runat="server" Class="btn btn-primary m-b-0" Text="Complete" data-type="success" data-from="top" data-align="right" onclick="Complete" /> 
                      <asp:Button ID="DropT" type="submit" runat="server" Class="btn btn-primary m-b-0" Text="Drop Ticket" data-type="success" data-from="top" data-align="right" onclick="DropTicket" /> 
                  </div>
                </div>
              </div>      
            </div>
