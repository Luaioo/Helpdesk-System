...
{
    public partial class UserAddTickets : System.Web.UI.Page
    {
        ...
        protected void Add_Ticket(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                String Query = "INSERT INTO [dbo].[Tickets] (Users, Title, Email ,Department ,UserID, UserEmail, Description, Status, Reportdate )  VALUES (@Users, @Title, @Email ,@Department ,@UserID, @UserEmail, @Description, @Status,  @Reportdate ) ";
